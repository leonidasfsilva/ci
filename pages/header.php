            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                            <a href="#">
                                <i class="fa fa-user fa-fw"></i> Perfil de Usuário</a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li>
                            <a href="login">
                                <i class="fa fa-sign-out fa-fw fa-rotate-180"></i> Sair</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot">Gráficos Flutuantes</a>
                                </li>
                                <li>
                                    <a href="morris">Gráficos Morris.js</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="tables">
                                <i class="fa fa-table fa-fw"></i> Tabelas</a>
                        </li>
                        <li>
                            <a href="forms">
                                <i class="fa fa-edit fa-fw"></i> Formulários</a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa fa-wrench fa-fw"></i> Elementos UI
                                <span class="fa arrow"></span>
                            </a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="panels-wells">Painéis e Wells</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-sitemap fa-fw"></i> Dropdown Multi-Nível
                                <span class="fa arrow"></span>
                            </a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-files-o fa-fw"></i> Páginas de Amostra
                                <span class="fa arrow"></span>
                            </a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="blank">Página em Branco</a>
                                </li>
                                <li>
