            ...
            <form method="post" action="<?=site_url('admin/cadastraAdmin')?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="administradornome" name="administradornome" placeholder="Nome" required autofocus>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" id="administradoremail" name="administradoremail" placeholder="E-mail" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" id="administradorsenha" name="administradorsenha" placeholder="Senha" required>
                    </div>
                </div>
