...
<div class="content-wrapper">
    <div class="container-fluid">
            ...
            <h3>Alterar cadastro de usuário</h3>
            ...
            <form method="post" action="<?=site_url('admin/alteraDadosAdmin/'.$admin->idadministrador) ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input value="<?= $admin->administradornome ?>" type="text" class="form-control" id="administradornome" name="administradornome" placeholder="Nome do administrador" autofocus>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input value="<?= $admin->administradoremail ?>" type="email" class="form-control" id="administradoremail" name="administradoremail" placeholder="E-mail do administrador">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" id="administradorsenha" name="administradorsenha" placeholder="Senha do administrador">
                    </div>
                ...
                <a href="javascript:history.back();" class="btn btn-outline-secondary btn-sm"><i class="fa fa-times fa-fw"></i> Cancelar</a>
