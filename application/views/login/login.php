...
<?php if (isset($tokenInvalido) == true) { ?>
    <script>
        swal({
            ...
            type: 'error',
            title: 'Link inválido!',
            html: 'Este link de redefinição é inválido.<br>Você pode solicitar um novo link clicando no botão abaixo.',
            showConfirmButton: true,
            showCancelButton: true,
            reverseButtons: true,
...
<?php if (isset($tokenExpirado) == true) { ?>
    <script>
        swal({
            ...
            type: 'error',
            title: 'Link expirado!',
            html: 'Este link de redefinição está expirado.<br>Você pode solicitar um novo link clicando no botão abaixo.',
            showConfirmButton: true,
            showCancelButton: true,
            reverseButtons: true,
            confirmButtonText: '<i class="fa fa-exchange fa-fw"></i> Novo link ',
